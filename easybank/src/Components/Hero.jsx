...
function Hero() {
	return (
		<div className='w-full lg:h-[89%] flex justify-center md:justify-end items-center relative z-10 py-5 md:py-0'>
			<div className='w-11/12 lg:h-full flex items-start justify-start lg:justify-between lg:items-center relative overflow-hidden'>
				<div className='w-full md:w-1/2 flex flex-col justify-center md:justify-start items-center md:items-start gap-8 py-0 md:py-5 lg:py-0'>
