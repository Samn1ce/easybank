...
function Decision() {
	return (
		<section className='w-full lg:h-[90vh] p-5 lg:p-0 flex bg-zinc-200 items-center justify-center font-public'>
			<div className='max-w-7xl mx-auto w-5/6 lg:h-full flex flex-col justify-center gap-8 sm:gap-20'>
