...
function Hero() {
	return (
		<div className='max-w-7xl mx-auto h-full grid md:grid-cols-2'>
			<div className='order-last flex flex-col text-center md:text-left lg:items-start justify-center md:order-first mx-auto max-w-lg p-8 h-full'>
			...
			<div className='order-first md:order-last h-[26rem] md:h-full'>
				<div>
					<IconBG className='absolute -top-60 w-[1000px] -left-16 md:-right-64 md:top-20 md:w-[850px] lg:w-[1100px] lg:-top-28 lg:-right-72 md:left-auto' />
				</div>
			</div>
		</div>
	)
